...
let newSauce2 = new HotSauce2('Chilli Wave', 4600)
//Console logs 'Chilli Wave is too hot!'
console.log(newSauce2.getName())
console.log(newSauce2.name) //as you see defined 
...
console.log(Utility2.classDetails()) //Utility Functions by Some Author



//redefine classDetails() to something completely different:
Utility2.classDetails = function() { 
    return "classDetails - corrupted"
}

console.log(Utility2.classDetails()) //classDetails - corrupted


///you can not call static method by instance 
let callUtility2 = new Utility2() //in Java it is possible 
console.log(callUtility2.classDetails()) //TypeError: callUtility.classDetails is not a function
