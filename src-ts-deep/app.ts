...
import { Book, Logger, Author, Librarian, Magazine } from './2-typescript-advanced-m2-exercise-files/After/LibraryManager/interfaces';
import { UniversityLibrarian, ReferenceItem, Employee, Researcher } from './2-typescript-advanced-m2-exercise-files/After/LibraryManager/classes';
